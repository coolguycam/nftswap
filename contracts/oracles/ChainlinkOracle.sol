...
import "@openzeppelin/contracts/introspection/IERC721.sol";

/**
 * @title Chainlink Oracle
 * @author Cameron Dimitroff
 * @notice Contract in charge or reading the information from a Chainlink Oracle. NFTswap contracts read the price directly from this contract. More information can be found on Chainlink Documentation
 */
